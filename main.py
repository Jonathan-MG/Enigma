...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Enigma")
        self.iconbitmap('C:\\Users\\jonat\\Desktop\\Enigma\\enigma_icon_ico.ico')
        ...
        self.label_entrada_de_texto = customtkinter.CTkLabel(self, text="Digite a mensagem/código:", text_color="white", font=("Arial",14))
        ...
        self.mensagem = customtkinter.CTkTextbox(self, height=10, corner_radius=15, fg_color='white', text_color="black", font=("Arial",14))
        ...
        self.label_rotor_1 = customtkinter.CTkLabel(self, text="1° Rotor", text_color="white", font=("Arial",14))
        self.label_rotor_1.grid(row=posicao_label_rotores[0], column=posicao_label_rotores[1], padx=(10,0), sticky = "we")

        self.label_rotor_2 = customtkinter.CTkLabel(self, text="2° Rotor", text_color="white", font=("Arial",14))
        self.label_rotor_2.grid(row=posicao_label_rotores[0], column=posicao_label_rotores[1]+1, padx=(10,0), sticky = "we")

        self.label_rotor_3 = customtkinter.CTkLabel(self, text="3° Rotor", text_color="white", font=("Arial",14))
        self.label_rotor_3.grid(row=posicao_label_rotores[0], column=posicao_label_rotores[1]+2, padx=(10,0), sticky = "we")
        
        # Escolha dos Rotores
        self.rotor_1 = customtkinter.CTkComboBox(self, command=self.escolha_rotor, values=lista_de_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        self.rotor_1.grid(row=posicao_inicial_rotores[0], column=posicao_inicial_rotores[1], padx=10, pady=5, sticky = "we")
        self.rotor_1.set("I")

        self.rotor_2 = customtkinter.CTkComboBox(self, command=self.escolha_rotor,values=lista_de_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        self.rotor_2.grid(row=posicao_inicial_rotores[0], column=posicao_inicial_rotores[1]+1, padx=10, pady=5, sticky = "we")
        self.rotor_2.set("II")

        self.rotor_3 = customtkinter.CTkComboBox(self, command=self.escolha_rotor,values=lista_de_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        ...
        self.titulo_posicao_rotores = customtkinter.CTkLabel(self, text="Posição Inicial dos Rotores", text_color="white", font=("Arial",14))
        ...
        self.texto_posicao_rotor_1 = customtkinter.CTkLabel(self, text="1° Rotor", text_color="white", font=("Arial",14))
        ...
        self.texto_posicao_rotor_2 = customtkinter.CTkLabel(self, text="2° Rotor", text_color="white", font=("Arial",14))
        ...
        self.texto_posicao_rotor_3 = customtkinter.CTkLabel(self, text="3° Rotor", text_color="white", font=("Arial",14))
        ...
        # Posição dos Rotores
        self.posicao_rotor_1 = customtkinter.CTkComboBox(self, command=self.escolha_posicao, values=lista_de_posicoes_dos_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        ...
        self.posicao_rotor_2 = customtkinter.CTkComboBox(self, command=self.escolha_posicao,values=lista_de_posicoes_dos_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        ...
        self.posicao_rotor_3 = customtkinter.CTkComboBox(self, command=self.escolha_posicao,values=lista_de_posicoes_dos_rotores, justify=combo_box_justify, width=combo_box_width, height=combo_box_height, state=combo_box_state, button_color='black', dropdown_fg_color='black', corner_radius=10, border_width=0, font=("Arial",14), dropdown_font=("Arial",14), text_color="#FFB90F", dropdown_text_color="#FFB90F")
        ...
        # Label Caixa do texto Encriptado/Decriptado
        self.label_caixa_de_texto = customtkinter.CTkLabel(self, text="Mensagem Encriptada/Decriptada:", text_color="white", font=("Arial",14))
        ...
        self.caixa_de_texto = customtkinter.CTkTextbox(self, width=100, height=50, corner_radius=15, state="disabled", fg_color="#FFB90F", text_color="black", font=("Arial",14))
